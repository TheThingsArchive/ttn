...
func (m *ActivationMetadata) MarshalTo(data []byte) (int, error) {
	...
	if m.NwkSKey != nil {
		...
		n3, err := m.NwkSKey.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n3
...
func (m *PHYPayload) MarshalTo(data []byte) (int, error) {
	...
	if m.Mhdr != nil {
		...
		n4, err := m.Mhdr.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n4
	...
	if m.MACPayload != nil {
		...
		n5, err := m.MACPayload.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *MACPayload) MarshalTo(data []byte) (int, error) {
	...
	if m.FHdr != nil {
		...
		n6, err := m.FHdr.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n6
...
func (m *FHdr) MarshalTo(data []byte) (int, error) {
	...
	if m.FCtrl != nil {
		...
		n8, err := m.FCtrl.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n8
...
var fileDescriptorLorawan = []byte{
	...
	,
}
