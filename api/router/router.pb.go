...
func (m *GatewayStatusResponse) MarshalTo(data []byte) (int, error) {
	...
	if m.LastStatus != nil {
		...
		n12, err := m.LastStatus.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n12
...
var fileDescriptorRouter = []byte{
	...
	,
}
