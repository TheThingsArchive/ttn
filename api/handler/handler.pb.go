...
type Application struct {
	...
	// Flag that is set if on-join registration is activated on that application.
	OnJoinRegistration bool `protobuf:"varint,7,opt,name=on_join_registration,json=onJoinRegistration,proto3" json:"on_join_registration,omitempty"`
	// If on-join registration is activated, contains the name of the access key to interact
	// with the account server.
	OnJoinRegistrationAccessKeyName string `protobuf:"bytes,8,opt,name=on_join_registration_access_key_name,json=onJoinRegistrationAccessKeyName,proto3" json:"on_join_registration_access_key_name,omitempty"`
}
...
func (m *Application) GetOnJoinRegistration() bool {
	if m != nil {
		return m.OnJoinRegistration
	}
	return false
}

func (m *Application) GetOnJoinRegistrationAccessKeyName() string {
	if m != nil {
		return m.OnJoinRegistrationAccessKeyName
	}
	return ""
}
...
type HandlerClient interface {
	...
	OnJoinRegistration(ctx context.Context, in *broker.OnJoinRegistrationRequest, opts ...grpc.CallOption) (*broker.OnJoinRegistrationResponse, error)
}
...
func (c *handlerClient) OnJoinRegistration(ctx context.Context, in *broker.OnJoinRegistrationRequest, opts ...grpc.CallOption) (*broker.OnJoinRegistrationResponse, error) {
	out := new(broker.OnJoinRegistrationResponse)
	err := grpc.Invoke(ctx, "/handler.Handler/OnJoinRegistration", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type HandlerServer interface {
	...
	OnJoinRegistration(context.Context, *broker.OnJoinRegistrationRequest) (*broker.OnJoinRegistrationResponse, error)
}
...
func _Handler_OnJoinRegistration_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(broker.OnJoinRegistrationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HandlerServer).OnJoinRegistration(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/handler.Handler/OnJoinRegistration",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HandlerServer).OnJoinRegistration(ctx, req.(*broker.OnJoinRegistrationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Handler_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "OnJoinRegistration",
			Handler:    _Handler_OnJoinRegistration_Handler,
		},
	},
...
type ApplicationManagerClient interface {
	...
	// SetRegisterOnJoin activates or deactivates on-join registration for an app
	SetRegisterOnJoin(ctx context.Context, in *lorawan1.SetRegisterOnJoinMessage, opts ...grpc.CallOption) (*google_protobuf.Empty, error)
...
func (c *applicationManagerClient) SetRegisterOnJoin(ctx context.Context, in *lorawan1.SetRegisterOnJoinMessage, opts ...grpc.CallOption) (*google_protobuf.Empty, error) {
	out := new(google_protobuf.Empty)
	err := grpc.Invoke(ctx, "/handler.ApplicationManager/SetRegisterOnJoin", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ApplicationManagerServer interface {
	...
	// SetRegisterOnJoin activates or deactivates on-join registration for an app
	SetRegisterOnJoin(context.Context, *lorawan1.SetRegisterOnJoinMessage) (*google_protobuf.Empty, error)
	// GetDevice returns the device with the given identifier (app_id and dev_id)
...
func _ApplicationManager_SetRegisterOnJoin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(lorawan1.SetRegisterOnJoinMessage)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApplicationManagerServer).SetRegisterOnJoin(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/handler.ApplicationManager/SetRegisterOnJoin",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApplicationManagerServer).SetRegisterOnJoin(ctx, req.(*lorawan1.SetRegisterOnJoinMessage))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _ApplicationManager_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ApplicationManager_SetRegisterOnJoin_Handler,
		},
		{
...
func (m *Application) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.OnJoinRegistrationAccessKeyName) > 0 {
		dAtA[i] = 0x42
		i++
		i = encodeVarintHandler(dAtA, i, uint64(len(m.OnJoinRegistrationAccessKeyName)))
		i += copy(dAtA[i:], m.OnJoinRegistrationAccessKeyName)
	}
	return i, nil
}
...
func (m *Application) Size() (n int) {
	...
	l = len(m.OnJoinRegistrationAccessKeyName)
	if l > 0 {
		n += 1 + l + sovHandler(uint64(l))
	}
	return n
...
func (m *Application) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OnJoinRegistration", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OnJoinRegistration = bool(v != 0)
		case 8:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OnJoinRegistrationAccessKeyName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OnJoinRegistrationAccessKeyName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipHandler(dAtA[iNdEx:])
...
var fileDescriptorHandler = []byte{
	...
	,
}
