...
type Device struct {
	...
	CustomKeys  map[string]string `protobuf:"bytes,13,rep,name=custom_keys,json=customKeys" json:"custom_keys,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *Device) GetCustomKeys() map[string]string {
	if m != nil {
		return m.CustomKeys
	}
	return nil
...
func (this *Device) VerboseEqual(that interface{}) error {
	...
	if len(this.CustomKeys) != len(that1.CustomKeys) {
		return fmt.Errorf("CustomKeys this(%v) Not Equal that(%v)", len(this.CustomKeys), len(that1.CustomKeys))
	}
	for i := range this.CustomKeys {
		if this.CustomKeys[i] != that1.CustomKeys[i] {
			return fmt.Errorf("CustomKeys this[%v](%v) Not Equal that[%v](%v)", i, this.CustomKeys[i], i, that1.CustomKeys[i])
		}
	}
...
func (this *Device) String() string {
	...
	keysForCustomKeys := make([]string, 0, len(this.CustomKeys))
	for k, _ := range this.CustomKeys {
		keysForCustomKeys = append(keysForCustomKeys, k)
	}
	github_com_gogo_protobuf_sortkeys.Strings(keysForCustomKeys)
	mapStringForCustomKeys := "map[string]string{"
	for _, k := range keysForCustomKeys {
		mapStringForCustomKeys += fmt.Sprintf("%v: %v,", k, this.CustomKeys[k])
	}
	mapStringForCustomKeys += "}"
	s := strings.Join([]string{`&Device{`,
		...
		`CustomKeys:` + mapStringForCustomKeys + `,`,
...
func (m *Device) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CustomKeys", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorHandler = []byte{
	...
	,
}
