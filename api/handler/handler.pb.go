...
func (*Attribute) Descriptor() ([]byte, []int) { return fileDescriptorHandler, []int{6} }
...
func (m *Attribute) GetVal() string {
	if m != nil {
		return m.Val
	}
	return ""
...
type Device struct {
	...
	Builtin     []*Attribute    `protobuf:"bytes,13,rep,name=builtin" json:"builtin,omitempty"`
	Description string          `protobuf:"bytes,20,opt,name=description,proto3" json:"description,omitempty"`
}

func (m *Device) Reset()                    { *m = Device{} }
func (*Device) ProtoMessage()               {}
func (*Device) Descriptor() ([]byte, []int) { return fileDescriptorHandler, []int{7} }
...
func (m *Device) GetBuiltin() []*Attribute {
	if m != nil {
		return m.Builtin
	}
	return nil
...
func (*DeviceList) Descriptor() ([]byte, []int) { return fileDescriptorHandler, []int{8} }
...
func (*DryDownlinkMessage) Descriptor() ([]byte, []int) { return fileDescriptorHandler, []int{9} }
...
func (*DryUplinkMessage) Descriptor() ([]byte, []int) { return fileDescriptorHandler, []int{10} }
...
func (*SimulatedUplinkMessage) Descriptor() ([]byte, []int) { return fileDescriptorHandler, []int{11} }
...
func (*LogEntry) Descriptor() ([]byte, []int) { return fileDescriptorHandler, []int{12} }
...
func (*DryUplinkResult) Descriptor() ([]byte, []int) { return fileDescriptorHandler, []int{13} }
...
func (*DryDownlinkResult) Descriptor() ([]byte, []int) { return fileDescriptorHandler, []int{14} }
...
func init() {
	...
	proto.RegisterType((*Attribute)(nil), "handler.Attribute")
...
func (this *Device) VerboseEqual(that interface{}) error {
	...
	if len(this.Builtin) != len(that1.Builtin) {
		return fmt.Errorf("Builtin this(%v) Not Equal that(%v)", len(this.Builtin), len(that1.Builtin))
	}
	for i := range this.Builtin {
		if !this.Builtin[i].Equal(that1.Builtin[i]) {
			return fmt.Errorf("Builtin this[%v](%v) Not Equal that[%v](%v)", i, this.Builtin[i], i, that1.Builtin[i])
		}
	}
...
func (m *Attribute) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Key) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintHandler(dAtA, i, uint64(len(m.Key)))
		i += copy(dAtA[i:], m.Key)
	}
	if len(m.Val) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintHandler(dAtA, i, uint64(len(m.Val)))
		i += copy(dAtA[i:], m.Val)
	}
	return i, nil
}
...
func (this *Device) String() string {
	...
	s := strings.Join([]string{`&Device{`,
		...
		`Builtin:` + strings.Replace(fmt.Sprintf("%v", this.Builtin), "Attribute", "Attribute", 1) + `,`,
...
func (m *Device) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			...
			m.Builtin = append(m.Builtin, &Attribute{})
			if err := m.Builtin[len(m.Builtin)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 20:
...
var fileDescriptorHandler = []byte{
	...
	,
}
