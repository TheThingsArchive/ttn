...
type Application struct {
	...
	OnJoinRegistrationEnabled bool `protobuf:"varint,7,opt,name=on_join_registration_enabled,json=onJoinRegistrationEnabled,proto3" json:"on_join_registration_enabled,omitempty"`
}
...
func (m *Application) GetOnJoinRegistrationEnabled() bool {
	if m != nil {
		return m.OnJoinRegistrationEnabled
	}
	return false
}
...
func (m *Application) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.OnJoinRegistrationEnabled {
		dAtA[i] = 0x38
		i++
		if m.OnJoinRegistrationEnabled {
			dAtA[i] = 1
...
func (m *Application) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OnJoinRegistrationEnabled", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OnJoinRegistrationEnabled = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipHandler(dAtA[iNdEx:])
			if err != nil {
...
var fileDescriptorHandler = []byte{
	...
	,
}
