...
type NetworkServerClient interface {
	...
	GetDevice(ctx context.Context, in *lorawan.DeviceIdentifier, opts ...grpc.CallOption) (*lorawan.Device, error)
...
func (c *networkServerClient) GetDevice(ctx context.Context, in *lorawan.DeviceIdentifier, opts ...grpc.CallOption) (*lorawan.Device, error) {
	out := new(lorawan.Device)
	err := grpc.Invoke(ctx, "/networkserver.NetworkServer/GetDevice", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type NetworkServerServer interface {
	...
	GetDevice(context.Context, *lorawan.DeviceIdentifier) (*lorawan.Device, error)
	// Broker requests device activation "template" from Network Server
...
func _NetworkServer_GetDevice_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(lorawan.DeviceIdentifier)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/networkserver.NetworkServer/GetDevice",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NetworkServerServer).GetDevice(ctx, req.(*lorawan.DeviceIdentifier))
	}
	return interceptor(ctx, in, info, handler)
}
...
var fileDescriptorNetworkserver = []byte{
	...
	,
}
