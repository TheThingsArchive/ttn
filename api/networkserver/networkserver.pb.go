...
type Device struct {
	...
	StoredFCnt       uint32                                              `protobuf:"varint,4,opt,name=stored_f_cnt,json=storedFCnt,proto3" json:"stored_f_cnt,omitempty"`
...
func (*Device) Descriptor() ([]byte, []int) { return fileDescriptorNetworkserver, []int{1} }

type DevicesResponse struct {
	Results []*Device `protobuf:"bytes,1,rep,name=results" json:"results,omitempty"`
}
...
func (*DevicesResponse) Descriptor() ([]byte, []int) { return fileDescriptorNetworkserver, []int{2} }

func (m *DevicesResponse) GetResults() []*Device {
	if m != nil {
		return m.Results
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*Device)(nil), "networkserver.Device")
...
func (m *Device) MarshalTo(data []byte) (int, error) {
	...
	if m.StoredFCnt != 0 {
		data[i] = 0x20
		i++
		i = encodeVarintNetworkserver(data, i, uint64(m.StoredFCnt))
	}
	if m.FullFCnt != 0 {
		data[i] = 0x28
		i++
		i = encodeVarintNetworkserver(data, i, uint64(m.FullFCnt))
	}
	if len(m.AppId) > 0 {
		data[i] = 0x32
		i++
		i = encodeVarintNetworkserver(data, i, uint64(len(m.AppId)))
...
func (m *Device) Size() (n int) {
	...
	if m.StoredFCnt != 0 {
		n += 1 + sovNetworkserver(uint64(m.StoredFCnt))
	}
	if m.FullFCnt != 0 {
		n += 1 + sovNetworkserver(uint64(m.FullFCnt))
	}
	l = len(m.AppId)
	if l > 0 {
		n += 1 + l + sovNetworkserver(uint64(l))
...
func (m *Device) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field StoredFCnt", wireType)
			}
			m.StoredFCnt = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := data[iNdEx]
				iNdEx++
				m.StoredFCnt |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorNetworkserver = []byte{
	...
	,
}
