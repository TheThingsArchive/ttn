...
type RxMetadata struct {
	...
	RssiChannel float32 `protobuf:"fixed32,32,opt,name=rssi_channel,json=rssiChannel,proto3" json:"rssi_channel,omitempty"`
...
func (m *RxMetadata) GetRssiChannel() float32 {
	if m != nil {
...
type RxMetadata_Antenna struct {
	...
	// Received signal strength in dBm
	RssiChannel float32 `protobuf:"fixed32,3,opt,name=rssi_channel,json=rssiChannel,proto3" json:"rssi_channel,omitempty"`
	// Signal-to-noise-ratio in dB
	...
	// Wanted rssi signal (dBm)
	RssiSignal float32 `protobuf:"fixed32,6,opt,name=rssi_signal,json=rssiSignal,proto3" json:"rssi_signal,omitempty"`
	// Frequency offset (Hz)
...
var fileDescriptorGateway = []byte{
	...
	,
}
