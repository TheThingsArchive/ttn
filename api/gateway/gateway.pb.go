...
type StatusMessage struct {
	...
	// Types that are valid to be assigned to Gateway:
	//	*StatusMessage_Semtech
	Gateway isStatusMessage_Gateway `protobuf_oneof:"gateway"`
}

func (m *StatusMessage) Reset()                    { *m = StatusMessage{} }
func (m *StatusMessage) String() string            { return proto.CompactTextString(m) }
func (*StatusMessage) ProtoMessage()               {}
func (*StatusMessage) Descriptor() ([]byte, []int) { return fileDescriptorGateway, []int{3} }

type isStatusMessage_Gateway interface {
	isStatusMessage_Gateway()
	MarshalTo([]byte) (int, error)
	Size() int
}

type StatusMessage_Semtech struct {
	Semtech *semtech.StatusMessage `protobuf:"bytes,51,opt,name=semtech,oneof"`
}

func (*StatusMessage_Semtech) isStatusMessage_Gateway() {}

func (m *StatusMessage) GetGateway() isStatusMessage_Gateway {
	if m != nil {
		return m.Gateway
	}
	return nil
...
func (m *StatusMessage) GetGps() *GPSMetadata {
	if m != nil {
		return m.Gps
	}
	return nil
...
func (m *StatusMessage) GetSemtech() *semtech.StatusMessage {
	if x, ok := m.GetGateway().(*StatusMessage_Semtech); ok {
		return x.Semtech
	}
	return nil
}
...
// XXX_OneofFuncs is for the internal use of the proto package.
func (*StatusMessage) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _StatusMessage_OneofMarshaler, _StatusMessage_OneofUnmarshaler, _StatusMessage_OneofSizer, []interface{}{
		(*StatusMessage_Semtech)(nil),
	}
}

func _StatusMessage_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	m := msg.(*StatusMessage)
	// gateway
	switch x := m.Gateway.(type) {
	case *StatusMessage_Semtech:
	...
	case nil:
	default:
		return fmt.Errorf("StatusMessage.Gateway has unexpected type %T", x)
	}
	return nil
}

func _StatusMessage_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	m := msg.(*StatusMessage)
	switch tag {
	case 51: // gateway.semtech
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(semtech.StatusMessage)
		err := b.DecodeMessage(msg)
		m.Gateway = &StatusMessage_Semtech{msg}
		return true, err
	default:
		return false, nil
	}
...
func _StatusMessage_OneofSizer(msg proto.Message) (n int) {
	m := msg.(*StatusMessage)
	// gateway
	switch x := m.Gateway.(type) {
	case *StatusMessage_Semtech:
...
func init() {
	...
	proto.RegisterType((*StatusMessage)(nil), "gateway.StatusMessage")
}
...
func (m *StatusMessage) MarshalTo(data []byte) (int, error) {
	...
	if m.Gateway != nil {
		nn6, err := m.Gateway.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += nn6
...
func (m *StatusMessage_Semtech) MarshalTo(data []byte) (int, error) {
	i := 0
	if m.Semtech != nil {
		data[i] = 0x9a
		i++
		...
		i++
		i = encodeVarintGateway(data, i, uint64(m.Semtech.Size()))
		n7, err := m.Semtech.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n7
...
func (m *StatusMessage_Semtech) Size() (n int) {
	var l int
	_ = l
	if m.Semtech != nil {
		l = m.Semtech.Size()
...
func (m *StatusMessage) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 51:
			...
			v := &semtech.StatusMessage{}
			if err := v.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Gateway = &StatusMessage_Semtech{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipGateway(data[iNdEx:])
...
var fileDescriptorGateway = []byte{
	...
	,
}
