...
type RxMetadata_Antenna struct {
	...
	Rssisd float32 `protobuf:"fixed32,5,opt,name=rssisd,proto3" json:"rssisd,omitempty"`
	// Wanted rssi signal
	Rssis float32 `protobuf:"fixed32,6,opt,name=rssis,proto3" json:"rssis,omitempty"`
	// ns-level Rx fine timestamp
	Ftime uint64 `protobuf:"varint,7,opt,name=ftime,proto3" json:"ftime,omitempty"`
	// Frequency offset
	FrequencyOffset uint64 `protobuf:"varint,8,opt,name=frequency_offset,json=frequencyOffset,proto3" json:"frequency_offset,omitempty"`
	// Encrypted time from the Gateway FPGA in base64
	EncryptedTime string `protobuf:"bytes,10,opt,name=encrypted_time,json=encryptedTime,proto3" json:"encrypted_time,omitempty"`
}
...
func (m *RxMetadata_Antenna) GetRssisd() float32 {
	if m != nil {
		return m.Rssisd
	}
	return 0
...
func (m *RxMetadata_Antenna) GetRssis() float32 {
	if m != nil {
		return m.Rssis
	}
	return 0
...
func (m *RxMetadata_Antenna) GetFtime() uint64 {
	if m != nil {
		return m.Ftime
	}
	return 0
...
func (m *RxMetadata_Antenna) GetEncryptedTime() string {
	if m != nil {
		return m.EncryptedTime
	}
	return ""
...
func (this *RxMetadata_Antenna) VerboseEqual(that interface{}) error {
	...
	if this.Rssisd != that1.Rssisd {
		return fmt.Errorf("Rssisd this(%v) Not Equal that(%v)", this.Rssisd, that1.Rssisd)
	}
	if this.Rssis != that1.Rssis {
		return fmt.Errorf("Rssis this(%v) Not Equal that(%v)", this.Rssis, that1.Rssis)
	}
	if this.Ftime != that1.Ftime {
		return fmt.Errorf("Ftime this(%v) Not Equal that(%v)", this.Ftime, that1.Ftime)
	}
	...
	if this.EncryptedTime != that1.EncryptedTime {
		return fmt.Errorf("EncryptedTime this(%v) Not Equal that(%v)", this.EncryptedTime, that1.EncryptedTime)
	}
	return nil
}
...
func (m *RxMetadata_Antenna) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Rssisd != 0 {
		dAtA[i] = 0x2d
		i++
		i = encodeFixed32Gateway(dAtA, i, uint32(math.Float32bits(float32(m.Rssisd))))
	}
	if m.Rssis != 0 {
		dAtA[i] = 0x35
		i++
		i = encodeFixed32Gateway(dAtA, i, uint32(math.Float32bits(float32(m.Rssis))))
	}
	if m.Ftime != 0 {
		dAtA[i] = 0x38
		i++
		i = encodeVarintGateway(dAtA, i, uint64(m.Ftime))
	}
...
func (this *RxMetadata_Antenna) String() string {
	...
	s := strings.Join([]string{`&RxMetadata_Antenna{`,
		...
		`Rssi:` + fmt.Sprintf("%v", this.Rssi) + `,`,
		`Snr:` + fmt.Sprintf("%v", this.Snr) + `,`,
		`Rssisd:` + fmt.Sprintf("%v", this.Rssisd) + `,`,
		`Rssis:` + fmt.Sprintf("%v", this.Rssis) + `,`,
		`Ftime:` + fmt.Sprintf("%v", this.Ftime) + `,`,
...
func (m *RxMetadata_Antenna) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			if wireType != 5 {
				return fmt.Errorf("proto: wrong wireType = %d for field Rssisd", wireType)
			}
			var v uint32
			if (iNdEx + 4) > l {
				return io.ErrUnexpectedEOF
			...
			v |= uint32(dAtA[iNdEx-2]) << 16
			v |= uint32(dAtA[iNdEx-1]) << 24
			m.Rssisd = float32(math.Float32frombits(v))
		case 6:
			if wireType != 5 {
				return fmt.Errorf("proto: wrong wireType = %d for field Rssis", wireType)
			}
			var v uint32
			if (iNdEx + 4) > l {
				return io.ErrUnexpectedEOF
			...
			v |= uint32(dAtA[iNdEx-2]) << 16
			v |= uint32(dAtA[iNdEx-1]) << 24
			m.Rssis = float32(math.Float32frombits(v))
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field Ftime", wireType)
			}
			m.Ftime = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 10:
			...
			m.EncryptedTime = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipGateway(dAtA[iNdEx:])
...
var fileDescriptorGateway = []byte{
	...
	,
}
