...
func (m *DeduplicatedUplinkMessage) MarshalTo(data []byte) (int, error) {
	...
	if m.ResponseTemplate != nil {
		...
		n6, err := m.ResponseTemplate.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n6
...
func (m *DeviceActivationRequest) MarshalTo(data []byte) (int, error) {
	...
	if m.ActivationMetadata != nil {
		...
		n9, err := m.ActivationMetadata.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n9
...
func (m *DeduplicatedDeviceActivationRequest) MarshalTo(data []byte) (int, error) {
	...
	if m.ResponseTemplate != nil {
		...
		i++
		i = encodeVarintBroker(data, i, uint64(m.ResponseTemplate.Size()))
		n13, err := m.ResponseTemplate.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n13
...
func (m *StatusResponse) MarshalTo(data []byte) (int, error) {
	...
	if m.UplinkUnique != nil {
		...
		n15, err := m.UplinkUnique.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n15
	...
	if m.Downlink != nil {
		...
		n16, err := m.Downlink.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n16
	...
	if m.Activations != nil {
		...
		n17, err := m.Activations.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n17
	...
	if m.ActivationsUnique != nil {
		...
		n18, err := m.ActivationsUnique.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n18
	...
	if m.Deduplication != nil {
		...
		n20, err := m.Deduplication.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n20
...
var fileDescriptorBroker = []byte{
	...
	,
}
