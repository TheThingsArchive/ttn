...
type PrepareDownlinkRequest struct {
	DevEui *github_com_TheThingsNetwork_ttn_core_types.DevEUI `protobuf:"bytes,1,opt,name=dev_eui,json=devEui,proto3,customtype=github.com/TheThingsNetwork/ttn/core/types.DevEUI" json:"dev_eui,omitempty"`
...
func (m *PrepareDownlinkRequest) Reset()                    { *m = PrepareDownlinkRequest{} }
func (*PrepareDownlinkRequest) ProtoMessage()               {}
func (*PrepareDownlinkRequest) Descriptor() ([]byte, []int) { return fileDescriptorBroker, []int{10} }

func (m *PrepareDownlinkRequest) GetAppId() string {
	if m != nil {
		return m.AppId
	}
	return ""
...
func (m *PrepareDownlinkRequest) GetDevId() string {
	if m != nil {
		return m.DevId
	}
	return ""
...
func (*StatusRequest) Descriptor() ([]byte, []int) { return fileDescriptorBroker, []int{11} }
...
func (*Status) Descriptor() ([]byte, []int) { return fileDescriptorBroker, []int{12} }
...
func (*ApplicationHandlerRegistration) Descriptor() ([]byte, []int) {
	return fileDescriptorBroker, []int{13}
}
...
func init() {
	...
	proto.RegisterType((*PrepareDownlinkRequest)(nil), "broker.PrepareDownlinkRequest")
...
func (this *PrepareDownlinkRequest) VerboseEqual(that interface{}) error {
	if that == nil {
		if this == nil {
			return nil
		}
	...
	that1, ok := that.(*PrepareDownlinkRequest)
	if !ok {
		that2, ok := that.(PrepareDownlinkRequest)
		if ok {
			that1 = &that2
		} else {
			return fmt.Errorf("that is not of type *PrepareDownlinkRequest")
		}
	}
	if that1 == nil {
		if this == nil {
		...
		return fmt.Errorf("that is type *PrepareDownlinkRequest but is nil && this != nil")
	} else if this == nil {
		return fmt.Errorf("that is type *PrepareDownlinkRequest but is not nil && this == nil")
	}
	if that1.DevEui == nil {
		if this.DevEui != nil {
			return fmt.Errorf("this.DevEui != nil && that1.DevEui == nil")
...
func (this *PrepareDownlinkRequest) Equal(that interface{}) bool {
	if that == nil {
		if this == nil {
			return true
		}
...
type BrokerClient interface {
	...
	// Handler prepares a downlink message (class C)
	PrepareDownlink(ctx context.Context, in *PrepareDownlinkRequest, opts ...grpc.CallOption) (*DownlinkMessage, error)
...
func (c *brokerClient) PrepareDownlink(ctx context.Context, in *PrepareDownlinkRequest, opts ...grpc.CallOption) (*DownlinkMessage, error) {
	out := new(DownlinkMessage)
	err := grpc.Invoke(ctx, "/broker.Broker/PrepareDownlink", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BrokerServer interface {
	...
	// Handler prepares a downlink message (class C)
	PrepareDownlink(context.Context, *PrepareDownlinkRequest) (*DownlinkMessage, error)
	// Router requests device activation
...
func _Broker_PrepareDownlink_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PrepareDownlinkRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BrokerServer).PrepareDownlink(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/broker.Broker/PrepareDownlink",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BrokerServer).PrepareDownlink(ctx, req.(*PrepareDownlinkRequest))
	}
...
var _Broker_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "PrepareDownlink",
			Handler:    _Broker_PrepareDownlink_Handler,
		},
		{
			MethodName: "Activate",
...
func (m *PrepareDownlinkRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *PrepareDownlinkRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.DevEui != nil {
		...
		i++
		i = encodeVarintBroker(dAtA, i, uint64(m.DevEui.Size()))
		n41, err := m.DevEui.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n41
	...
	if m.AppEui != nil {
		...
		i++
		i = encodeVarintBroker(dAtA, i, uint64(m.AppEui.Size()))
		n42, err := m.AppEui.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n42
...
func (m *Status) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.System != nil {
		...
		n43, err := m.System.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n43
	...
	if m.Component != nil {
		...
		n44, err := m.Component.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n44
	...
	if m.Uplink != nil {
		...
		n45, err := m.Uplink.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n45
	...
	if m.UplinkUnique != nil {
		...
		n46, err := m.UplinkUnique.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n46
	...
	if m.Downlink != nil {
		...
		n47, err := m.Downlink.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n47
	...
	if m.Activations != nil {
		...
		n48, err := m.Activations.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n48
	...
	if m.ActivationsUnique != nil {
		...
		n49, err := m.ActivationsUnique.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n49
	...
	if m.Deduplication != nil {
		...
		n50, err := m.Deduplication.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n50
...
func (m *PrepareDownlinkRequest) Size() (n int) {
	var l int
	_ = l
	if m.DevEui != nil {
		l = m.DevEui.Size()
...
func (this *PrepareDownlinkRequest) String() string {
	if this == nil {
		return "nil"
	}
	s := strings.Join([]string{`&PrepareDownlinkRequest{`,
		`DevEui:` + fmt.Sprintf("%v", this.DevEui) + `,`,
		`AppEui:` + fmt.Sprintf("%v", this.AppEui) + `,`,
		`AppId:` + fmt.Sprintf("%v", this.AppId) + `,`,
		`DevId:` + fmt.Sprintf("%v", this.DevId) + `,`,
...
func (m *PrepareDownlinkRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PrepareDownlinkRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PrepareDownlinkRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
var fileDescriptorBroker = []byte{
	...
	,
}
