...
func (r httpRegistration) AppEUI() (lorawan.EUI64, error) {
	return lorawan.EUI64{}, errors.New(errors.Implementation, "AppEUI not supported on http registration")
}

// DevEUI implements the core.Registration interface
func (r httpRegistration) DevEUI() (lorawan.EUI64, error) {
	if r.devEUI == nil {
		return lorawan.EUI64{}, errors.New(errors.Implementation, "DevEUI not accessible on this registration")
	}
	return *r.devEUI, nil
}
...
func (r httpRegistration) AppSKey() (lorawan.AES128Key, error) {
	return lorawan.AES128Key{}, errors.New(errors.Implementation, "AppSKey not supported on http registration")
}

// NwkSKey implements the core.Registration interface
func (r httpRegistration) NwkSKey() (lorawan.AES128Key, error) {
	return lorawan.AES128Key{}, errors.New(errors.Implementation, "NextRegistration not supported on udp adapter")
}
