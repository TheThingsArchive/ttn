...
type LoRaWANJoinAccept struct {
	AppNonce   []byte             `protobuf:"bytes,1,opt,name=AppNonce,json=appNonce,proto3" json:"AppNonce,omitempty"`
	NetID      []byte             `protobuf:"bytes,2,opt,name=NetID,json=netID,proto3" json:"NetID,omitempty"`
	DevAddr    []byte             `protobuf:"bytes,3,opt,name=DevAddr,json=devAddr,proto3" json:"DevAddr,omitempty"`
	DLSettings *LoRaWANDLSettings `protobuf:"bytes,4,opt,name=DLSettings,json=dLSettings" json:"DLSettings,omitempty"`
	RXDelay    uint32             `protobuf:"varint,5,opt,name=RXDelay,json=rXDelay,proto3" json:"RXDelay,omitempty"`
}
...
func (m *LoRaWANJoinAccept) GetDLSettings() *LoRaWANDLSettings {
	if m != nil {
		return m.DLSettings
	}
	return nil
...
func (m *LoRaWANJoinAccept) MarshalTo(data []byte) (int, error) {
	...
	if m.DLSettings != nil {
		...
		n5, err := m.DLSettings.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *LoRaWANJoinAccept) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.DLSettings == nil {
				m.DLSettings = &LoRaWANDLSettings{}
			}
...
var fileDescriptorLorawan = []byte{
	...
	,
}
