...
type DataDownHandlerReq struct {
	...
	TTL     uint32 `protobuf:"varint,4,opt,name=TTL,json=tTL,proto3" json:"TTL,omitempty"`
}
...
func (m *DataDownHandlerReq) MarshalTo(data []byte) (int, error) {
	...
	if m.TTL != 0 {
		data[i] = 0x20
		i++
		i = encodeVarintHandler(data, i, uint64(m.TTL))
	}
	return i, nil
}
...
var fileDescriptorHandler = []byte{
	...
	,
}
