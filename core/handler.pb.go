...
type DataUpHandlerReq struct {
	...
	FCUPRst  bool      `protobuf:"varint,13,opt,name=FCUPRst,json=fCUPRst,proto3" json:"FCUPRst,omitempty"`
...
func (m *DataUpHandlerReq) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field FCUPRst", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
var fileDescriptorHandler = []byte{
	...
	,
}
