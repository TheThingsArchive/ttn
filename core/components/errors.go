...
var ErrAlreadyProcessed = fmt.Errorf("The packet reached the handler too late. It has already been processed.")
var ErrNotUnmarshable = fmt.Errorf("The given data structure isn't unmarshable")
var ErrStorageUnreachable = fmt.Errorf("Something went seriously wrong with the storage")
