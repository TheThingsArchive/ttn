...
func (b *broker) HandleUplink(uplink *pb.UplinkMessage) error {
	...
	getDevicesResp, err = b.ns.GetDevices(b.Component.GetContext(false), &networkserver.DevicesRequest{
		DevAddr: &devAddr,
	...
	deduplicatedUplink, err = b.ns.Uplink(b.Component.GetContext(false), deduplicatedUplink)
	if err != nil {
		return err
	}
