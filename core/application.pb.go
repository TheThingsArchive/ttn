...
/*
	...
	It has these top-level messages:
		...
		BrokerUpsertAppRes
		BrokerDevice
		BrokerListDevicesReq
		BrokerListDevicesRes
		BrokerUpsertDeviceReq
		BrokerUpsertDeviceRes
		Metadata
		StatsMetadata
		DataUpHandlerReq
		DataUpHandlerRes
		...
		JoinHandlerRes
		HandlerDevice
		HandlerListDevicesReq
		HandlerListDevicesRes
		HandlerUpsertDeviceReq
		HandlerUpsertDeviceRes
		LoRaWANData
		LoRaWANMHDR
		LoRaWANMACPayload
		LoRaWANFHDR
